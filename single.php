...
<head>
    ...
    <!-- Title -->
    <title>david Blog - Food Blog Template</title>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="logo_area text-center">
                        <a href="index.html" class="david-logo">david Blog</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#davidfood-nav" aria-controls="davidfood-nav" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars" aria-hidden="true"></i> Menu</button>
                        <!-- Menu Area Start -->
                        <div class="collapse navbar-collapse justify-content-center" id="davidfood-nav">
                            <ul class="navbar-nav" id="david-nav">
                                <li class="nav-item active">
                                    <a class="nav-link" href="index.html">Home <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="davidDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                                    <div class="dropdown-menu" aria-labelledby="davidDropdown">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                ...
                                <div class="post-content">
                                    ...
                                    <blockquote class="david-blockquote mt-30 mb-30">
                        ...
                        <div class="single-widget-area add-widget text-center">
                            <div class="add-widget-area">
                                ...
                                <div class="add-text">
                                    <div class="david-table">
                                        <div class="david-table-cell">
                                            <h2>Cooking Book</h2>
                ...
                <div class="col-12">
                    <div class="footer-content">
                        ...
                        <div class="footer-logo-area text-center">
                            <a href="" class="david-logo">david Ink</a>
                        </div>
                        <!-- Menu Area Start -->
                        <nav class="navbar navbar-expand-lg">
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#davidfood-footer-nav" aria-controls="davidfood-footer-nav" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars" aria-hidden="true"></i> Menu</button>
                            <!-- Menu Area Start -->
                            <div class="collapse navbar-collapse justify-content-center" id="davidfood-footer-nav">
                                <ul class="navbar-nav">
                                    <li class="nav-item active">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="copy_right_text text-center">
                        <p>Copyright @2018 All rights reserved<i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://megrov.github.io/mgs/" target="_blank">MG Software</a></p>
                    </div>
                </div>
            </div>
        </div>
